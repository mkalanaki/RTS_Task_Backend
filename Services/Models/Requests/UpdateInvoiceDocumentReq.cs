...
{
    public class UpdateInvoiceDocumentReq
    {
    ...
    public class UpdateInvoiceDocumentReqValidator : AbstractValidator<UpdateInvoiceDocumentReq>
    {
        public UpdateInvoiceDocumentReqValidator()
        {
